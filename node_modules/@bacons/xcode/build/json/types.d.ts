...
export declare type SourceTree = "BUILT_PRODUCTS_DIR" | "DEVELOPER_DIR" | "SOURCE_ROOT" | "SDKROOT" | "<group>" | "<absolute>";
/** UTI for product types. */
export declare type PBXProductType = "com.apple.product-type.application" | "com.apple.product-type.extensionkit-extension" | "com.apple.product-type.application.on-demand-install-capable" | "com.apple.product-type.framework" | "com.apple.product-type.library.dynamic" | "com.apple.product-type.library.static" | "com.apple.product-type.bundle" | "com.apple.product-type.bundle.unit-test" | "com.apple.product-type.bundle.ui-testing" | "com.apple.product-type.app-extension" | "com.apple.product-type.tool" | "com.apple.product-type.application.watchapp" | "com.apple.product-type.application.watchapp2" | "com.apple.product-type.application.watchapp2-container" | "com.apple.product-type.watchkit-extension" | "com.apple.product-type.watchkit2-extension" | "com.apple.product-type.tv-app-extension" | "com.apple.product-type.application.messages" | "com.apple.product-type.app-extension.messages" | "com.apple.product-type.app-extension.messages-sticker-pack" | "com.apple.product-type.xpc-service" | "com.apple.product-type.kernel-extension.iokit" | "com.apple.product-type.in-app-purchase-content" | "com.apple.product-type.kernel-extension";
export declare enum ProxyType {
    targetReference = 1,
    reference = 2
}
export declare type BoolNumber = 0 | 1;
export declare type BoolString = "YES" | "NO" | "YES_ERROR" | "YES_AGGRESSIVE";
/**
...
export interface AbstractFileObject<TISA extends ISA> extends AbstractObject<TISA> {
...
export interface AbstractPhysicalFileObject<TISA extends ISA> extends AbstractFileObject<TISA> {
    /**
...
export interface PBXFileReference extends AbstractPhysicalFileObject<ISA.PBXFileReference> {
    ...
    xcLanguageSpecificationIdentifier?: "xcode.lang.otd" | "xcode.lang.c" | "xcode.lang.cpp" | "xcode.lang.objc" | "xcode.lang.objcpp" | "xcode.lang.swift" | (string & {});
...
export interface PBXGroup<TISA extends ISA = ISA.PBXGroup, TChild = UUID> extends AbstractPhysicalFileObject<TISA> {
    /** List of UUIDs for objects of type `<PBXGroup|PBXReferenceProxy|PBXFileReference>` */
    children: TChild[];
}
/** Object for referencing localized resources. */
export interface PBXVariantGroup<TChild = UUID> extends PBXGroup<ISA.PBXVariantGroup, TChild> {
}
/** A group that references a folder on disk. */
export interface PBXFileSystemSynchronizedRootGroup<TException = UUID> extends AbstractPhysicalFileObject<ISA.PBXFileSystemSynchronizedRootGroup> {
...
export interface PBXFileSystemSynchronizedBuildFileExceptionSet<TTarget = UUID> extends AbstractObject<ISA.PBXFileSystemSynchronizedBuildFileExceptionSet> {
...
export interface PBXFileSystemSynchronizedGroupBuildPhaseMembershipExceptionSet<TBuildPhase = UUID> extends AbstractObject<ISA.PBXFileSystemSynchronizedGroupBuildPhaseMembershipExceptionSet> {
    /** Files with a platform filter. */
    platformFiltersByRelativePath?: Record<string, string[]>;
    /** List of relative paths to children subfolders for which exceptions are applied. */
    membershipExceptions?: string[];
...
export declare type FileType = "archive.ar" | "text" | "wrapper.extensionkit-extension" | "wrapper.application" | "wrapper.app-extension" | "wrapper.plug-in" | "sourcecode.cpp.cpp" | "compiled.mach-o.dylib" | "text.plist.entitlements" | "wrapper.framework" | "sourcecode.javascript" | "text.json" | "text.html" | "text.css" | "image.gif" | "text.xml" | "sourcecode.c.h" | "sourcecode.cpp.h" | "sourcecode.c.objc" | "text" | "folder" | "wrapper.cfbundle" | "sourcecode.module" | "video.quicktime" | "audio.mp3" | "wrapper.cfbundle" | "sourcecode.c.h" | "text.plist.xml" | "image.png" | "text.script.sh" | "file.sks" | "file.storyboard" | "text.plist.strings" | "sourcecode.swift" | "folder.assetcatalog" | "text.xcconfig" | "wrapper.xcdatamodel" | "wrapper.pb-project" | "wrapper.cfbundle" | "file.xib" | "file.intentdefinition" | "archive.zip";
export interface XCVersionGroup<TChild = UUID, TCurrentVersion = UUID> extends PBXGroup<ISA.XCVersionGroup, TChild> {
...
export interface AbstractBuildPhase<TISA extends ISA, TFile = UUID> extends AbstractObject<TISA> {
    /** @example `2147483647` */
 ...
 */
export interface PBXCopyFilesBuildPhase<TFile = UUID> extends AbstractBuildPhase<ISA.PBXCopyFilesBuildPhase, TFile> {
 ...
 */
export interface PBXSourcesBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXSourcesBuildPhase, TFiles> {
}
/**
 ...
 * - Can only be used once per target.
 */
export interface PBXResourcesBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXResourcesBuildPhase, TFiles> {
}
/**
 ...
 * - Can only be used once per target.
 */
export interface PBXHeadersBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXHeadersBuildPhase, TFiles> {
}
/**
 *
 * - ?? in Xcode.
 * - ??
 */
export interface PBXAppleScriptBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXAppleScriptBuildPhase, TFiles> {
}
/**
 * - 'Build Carbon Resources' in Xcode.
 * - Can be used multiple times per target.
 */
export interface PBXRezBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXRezBuildPhase, TFiles> {
}
/**
 * - 'Link Binary With Libraries' in Xcode.
 * - Can only be used once per target.
 */
export interface PBXFrameworksBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXFrameworksBuildPhase, TFiles> {
}
/**
 ...
 * - Can be used multiple times per target.
 */
export interface PBXShellScriptBuildPhase<TFiles = UUID> extends AbstractBuildPhase<ISA.PBXShellScriptBuildPhase, TFiles> {
    /** @example `Embed App Extensions` */
    name?: string;
    /**
...
export interface PBXBuildRule<TInputFile = UUID, TOutputFile = UUID> extends AbstractObject<ISA.PBXBuildRule> {
    name?: string;
    /** Indicates which compiler to use. */
    compilerSpec: "com.apple.compilers.proxy.script" | "com.apple.build-tasks.copy-strings-file" | (string & {});
    /** Discovered dependency file. */
    dependencyFile?: string;
...
export interface PBXReferenceProxy<TRemoteRef = UUID> extends AbstractFileObject<ISA.PBXReferenceProxy> {
...
export interface PBXLegacyTarget<TBuildConfigurationList = UUID, TDependency = UUID, TBuildPhase = UUID> extends AbstractTarget<ISA.PBXLegacyTarget, TBuildConfigurationList, TDependency, TBuildPhase> {
...
export interface PBXAggregateTarget<TBuildConfigurationList = UUID, TDependency = UUID, TBuildPhase = UUID> extends AbstractTarget<ISA.PBXAggregateTarget, TBuildConfigurationList, TDependency, TBuildPhase> {
}
/** A target used in Xcode */
export interface PBXNativeTarget<TBuildConfigurationList = UUID, TDependency = UUID, TBuildPhase = UUID, TBuildRule = UUID, TProductReference = UUID, TPackageProductDependency = UUID, TFileSystemSynchronizedGroups = UUID> extends AbstractTarget<ISA.PBXNativeTarget, TBuildConfigurationList, TDependency, TBuildPhase> {
...
export interface XCSwiftPackageProductDependency<TPackage = UUID> extends AbstractObject<ISA.XCSwiftPackageProductDependency> {
    /** UUID for an object of type `XCRemoteSwiftPackageReference` or `XCLocalSwiftPackageReference` */
    package?: TPackage;
    productName?: string;
}
export interface XCRemoteSwiftPackageReference extends AbstractObject<ISA.XCRemoteSwiftPackageReference> {
    /** URL the Swift package was installed from. */
    repositoryURL: string;
    /** Version requirements. */
    requirement?: Record<string, any>;
}
export interface XCLocalSwiftPackageReference extends AbstractObject<ISA.XCLocalSwiftPackageReference> {
    /** URL the Swift package was installed from. */
    path: string;
    /** Repository path where the package is located relative to the Xcode project. */
    relativePath: string;
}
export interface PBXContainerItemProxy<TContainerPortal = UUID, TRemoteGlobalIDString = UUID> extends AbstractObject<ISA.PBXContainerItemProxy> {
    containerPortal: TContainerPortal;
    /** @example `1` */
    proxyType: ProxyType;
    /** UUID */
    remoteGlobalIDString: TRemoteGlobalIDString;
    remoteInfo?: "ReferencedProject" | "iOS application" | "iOS staticLibrary" | (string & {});
}
/** This element is an abstract parent for specialized targets. */
export interface AbstractTarget<TTargetIsa extends ISA.PBXAggregateTarget | ISA.PBXLegacyTarget | ISA.PBXNativeTarget, TBuildConfigurationList = UUID, TDependencies = UUID, TBuildPhases = UUID> extends AbstractObject<TTargetIsa> {
 ...
 */
export interface PBXTargetDependency<TTarget = UUID, TTargetProxy = UUID> extends AbstractObject<ISA.PBXTargetDependency> {
...
export declare type XCBuildConfigurationName = "Release" | "Debug" | (string & {});
export interface XCConfigurationList<TBuildConfigurations = UUID> extends AbstractObject<ISA.XCConfigurationList> {
...
export interface XCBuildConfiguration<TBaseConfigurationReference = UUID> extends AbstractObject<ISA.XCBuildConfiguration> {
...
export interface PBXProject<TBuildConfigurationList = UUID, TMainGroup = UUID, TProductRefGroup = UUID, TTargets = UUID, TPackageReference = UUID> extends AbstractObject<ISA.PBXProject> {
...
export declare type TargetAttribute = {
...
export interface XCBuildConfiguration extends AbstractObject<ISA.XCBuildConfiguration> {
    buildSettings: BuildSettings;
    name: XCBuildConfigurationName;
}
export interface BuildSettings {
    ...
    SWIFT_ACTIVE_COMPILATION_CONDITIONS?: "DEBUG" | "DEBUG $(inherited)" | (string & {});
    ...
    CLANG_CXX_LANGUAGE_STANDARD?: "gnu++0x" | "gnu++14" | "gnu++20" | (string & {});
