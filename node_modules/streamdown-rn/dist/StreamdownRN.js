 ...
 * ```
 */
export const StreamdownRN = React.memo(({ children, componentRegistry, theme = 'dark', style, onError, onDebug, isComplete = false, }) => {
    ...
    return (<View style={containerStyle}>
      ...
      {registry.blocks.map(block => (<StableBlock key={block.id} block={block} theme={themeConfig} componentRegistry={componentRegistry}/>))}
      
      {/* Active block — re-renders on each token */}
      <ActiveBlock block={registry.activeBlock} tagState={registry.activeTagState} theme={themeConfig} componentRegistry={componentRegistry}/>
    </View>);
}, (prev, next) => {
...
//# sourceMappingURL=StreamdownRN.js.map